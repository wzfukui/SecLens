"""Aliyun security bulletin collector plugin."""
...
class AliyunCollector:
    """Encapsulates fetch and normalize logic for Aliyun bulletins."""
...
def run(
    ...
    If an ingest URL is supplied the collector will POST the payload to the API.
    Otherwise the normalized bulletins are returned for custom handling.
    """
